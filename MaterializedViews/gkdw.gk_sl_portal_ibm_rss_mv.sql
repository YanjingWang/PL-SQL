DROP MATERIALIZED VIEW GKDW.GK_SL_PORTAL_IBM_RSS_MV;
CREATE MATERIALIZED VIEW GKDW.GK_SL_PORTAL_IBM_RSS_MV 
TABLESPACE GDWSML
PCTUSED    0
PCTFREE    10
INITRANS   2
...
WITH PRIMARY KEY
AS 
/* Formatted on 29/01/2021 12:22:18 (QP5 v5.115.810.9015) */
SELECT   ev.line_id,
         ev.event_id,
         ev.course_code,
         ev.course_name,
 ...
 WHERE       ev.country NOT IN ('US', 'CA')
         AND SUBSTR (ev.course_code, 1, 4) IN ('5947', '5950', '3573')
...
COMMENT ON MATERIALIZED VIEW GKDW.GK_SL_PORTAL_IBM_RSS_MV IS 'snapshot table for snapshot GKDW.GK_SL_PORTAL_IBM_RSS_MV';

GRANT SELECT ON GKDW.GK_SL_PORTAL_IBM_RSS_MV TO DWHREAD;
