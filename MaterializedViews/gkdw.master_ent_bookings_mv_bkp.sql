DROP MATERIALIZED VIEW GKDW.MASTER_ENT_BOOKINGS_MV_BKP;
CREATE MATERIALIZED VIEW GKDW.MASTER_ENT_BOOKINGS_MV_BKP 
TABLESPACE GDWSML
PCTUSED    0
PCTFREE    10
INITRANS   2
...
WITH PRIMARY KEY
AS 
/* Formatted on 29/01/2021 12:20:20 (QP5 v5.115.810.9015) */
...
COMMENT ON MATERIALIZED VIEW GKDW.MASTER_ENT_BOOKINGS_MV_BKP IS 'snapshot table for snapshot GKDW.MASTER_ENT_BOOKINGS_MV_BKP';

GRANT SELECT ON GKDW.MASTER_ENT_BOOKINGS_MV_BKP TO DWHREAD;
