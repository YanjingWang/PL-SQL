DROP MATERIALIZED VIEW GKDW.MASTER_ENT_BOOKINGS_MV_$0;
CREATE MATERIALIZED VIEW GKDW.MASTER_ENT_BOOKINGS_MV_$0 
TABLESPACE GDWSML
PCTUSED    0
PCTFREE    10
INITRANS   2
...
WITH PRIMARY KEY
AS 
/* Formatted on 29/01/2021 12:20:26 (QP5 v5.115.810.9015) */
...
COMMENT ON MATERIALIZED VIEW GKDW.MASTER_ENT_BOOKINGS_MV_$0 IS 'snapshot table for snapshot GKDW.MASTER_ENT_BOOKINGS_MV_$0';
