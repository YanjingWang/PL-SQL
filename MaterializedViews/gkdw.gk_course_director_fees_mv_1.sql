DROP MATERIALIZED VIEW GKDW.GK_COURSE_DIRECTOR_FEES_MV_1;
CREATE MATERIALIZED VIEW GKDW.GK_COURSE_DIRECTOR_FEES_MV_1 
TABLESPACE GDWSML
PCTUSED    0
PCTFREE    10
INITRANS   2
...
WITH PRIMARY KEY
AS 
/* Formatted on 29/01/2021 12:25:45 (QP5 v5.115.810.9015) */
...
COMMENT ON MATERIALIZED VIEW GKDW.GK_COURSE_DIRECTOR_FEES_MV_1 IS 'snapshot table for snapshot GKDW.GK_COURSE_DIRECTOR_FEES_MV_1';
