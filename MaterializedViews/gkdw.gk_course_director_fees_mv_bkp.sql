DROP MATERIALIZED VIEW GKDW.GK_COURSE_DIRECTOR_FEES_MV_BKP;
CREATE MATERIALIZED VIEW GKDW.GK_COURSE_DIRECTOR_FEES_MV_BKP 
TABLESPACE GDWSML
PCTUSED    0
PCTFREE    10
INITRANS   2
...
WITH PRIMARY KEY
AS 
/* Formatted on 29/01/2021 12:25:42 (QP5 v5.115.810.9015) */
SELECT   p."us_code" prod_code,
 ...
 WHERE   cf."fee_type" IN ('Course Director Fee', 'Vendor Royalty Fee');

COMMENT ON MATERIALIZED VIEW GKDW.GK_COURSE_DIRECTOR_FEES_MV_BKP IS 'snapshot table for snapshot GKDW.GK_COURSE_DIRECTOR_FEES_MV_BKP';
