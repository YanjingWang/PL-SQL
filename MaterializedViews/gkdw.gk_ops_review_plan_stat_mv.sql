DROP MATERIALIZED VIEW GKDW.GK_OPS_REVIEW_PLAN_STAT_MV;
CREATE MATERIALIZED VIEW GKDW.GK_OPS_REVIEW_PLAN_STAT_MV 
TABLESPACE GDWLRG
PCTUSED    0
PCTFREE    10
INITRANS   2
...
WITH PRIMARY KEY
AS 
/* Formatted on 29/01/2021 12:23:47 (QP5 v5.115.810.9015) */
...
COMMENT ON MATERIALIZED VIEW GKDW.GK_OPS_REVIEW_PLAN_STAT_MV IS 'snapshot table for snapshot GKDW.GK_OPS_REVIEW_PLAN_STAT_MV';

GRANT SELECT ON GKDW.GK_OPS_REVIEW_PLAN_STAT_MV TO DWHREAD;
