DROP MATERIALIZED VIEW GKDW.MASTER_ENT_OE_BOOKING_MV_$0;
CREATE MATERIALIZED VIEW GKDW.MASTER_ENT_OE_BOOKING_MV_$0 
TABLESPACE GDWSML
PCTUSED    0
PCTFREE    10
INITRANS   2
...
WITH PRIMARY KEY
AS 
/* Formatted on 29/01/2021 12:20:14 (QP5 v5.115.810.9015) */
SELECT   DISTINCT 'Onsite' TYPE,
                  ...
                  cd.course_type
  FROM                  master_ent_bookings_mv_$0 me
                     LEFT OUTER JOIN
                        time_dim td
...
COMMENT ON MATERIALIZED VIEW GKDW.MASTER_ENT_OE_BOOKING_MV_$0 IS 'snapshot table for snapshot GKDW.MASTER_ENT_OE_BOOKING_MV_$0';
