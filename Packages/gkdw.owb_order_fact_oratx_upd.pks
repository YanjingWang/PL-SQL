DROP PACKAGE GKDW.OWB_ORDER_FACT_ORATX_UPD;

CREATE OR REPLACE PACKAGE GKDW."OWB_ORDER_FACT_ORATX_UPD"  AS
...
get_lob_uoid                  CONSTANT VARCHAR2(40) := 'A41FFB19C1FC5678E040007F01006C7D';
get_model_name                CONSTANT VARCHAR2(40) := '"OWB_ORDER_FACT_ORATX_UPD"';
...
-- Function Main -- Entry point in package "OWB_ORDER_FACT_ORATX_UPD"
--------------------------------------------------
