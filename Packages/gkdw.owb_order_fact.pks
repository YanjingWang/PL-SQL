DROP PACKAGE GKDW.OWB_ORDER_FACT;

CREATE OR REPLACE PACKAGE GKDW."OWB_ORDER_FACT"  AS
...
get_model_name                CONSTANT VARCHAR2(40) := '"OWB_ORDER_FACT"';
...
-- Function Main -- Entry point in package "OWB_ORDER_FACT"
--------------------------------------------------
