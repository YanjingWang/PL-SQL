DROP PACKAGE GKDW.OWB_INSTRUCTOR_DIM;

CREATE OR REPLACE PACKAGE GKDW."OWB_INSTRUCTOR_DIM"  AS
...
get_lob_uoid                  CONSTANT VARCHAR2(40) := 'A41FFB19A64B5678E040007F01006C7D';
get_model_name                CONSTANT VARCHAR2(40) := '"OWB_INSTRUCTOR_DIM"';
...
"CONST_0_TABLE_NAME" VARCHAR2(30) := 'INSTRUCTOR_DIM';
"CONST_1_SOURCE_NAME" VARCHAR2(20) := 'SLXDW';
...
FUNCTION "GET_CONST_1_SOURCE_NAME" RETURN VARCHAR2;
...
-- Function Main -- Entry point in package "OWB_INSTRUCTOR_DIM"
--------------------------------------------------
