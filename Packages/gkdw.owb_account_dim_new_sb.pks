DROP PACKAGE GKDW.OWB_ACCOUNT_DIM_NEW_SB;

CREATE OR REPLACE PACKAGE GKDW."OWB_ACCOUNT_DIM_NEW_SB"  AS
...
get_model_name                CONSTANT VARCHAR2(40) := '"OWB_ACCOUNT_DIM_NEW_SB"';
...
-- Function Main -- Entry point in package "OWB_ACCOUNT_DIM_NEW_SB"
--------------------------------------------------
