DROP PACKAGE GKDW.OWB_OPPORTUNITY_DIM;

CREATE OR REPLACE PACKAGE GKDW."OWB_OPPORTUNITY_DIM"  AS
...
get_lob_uoid                  CONSTANT VARCHAR2(40) := 'A41FFB19D46D5678E040007F01006C7D';
get_model_name                CONSTANT VARCHAR2(40) := '"OWB_OPPORTUNITY_DIM"';
...
"CONST_0_TABLE_NAME" VARCHAR2(30) := 'OPPORTUNITY_DIM';
"CONST_1_GKDW_SOURCE" VARCHAR2(30) := 'SLXDW';
"CONST_2_EO_NEXT_STEP" VARCHAR(64) := null;
"CONST_3_LEADSOURCE_ID" VARCHAR(50) := null;
...
FUNCTION "GET_CONST_1_GKDW_SOURCE" RETURN VARCHAR2;
FUNCTION "GET_CONST_2_EO_NEXT_STEP" RETURN VARCHAR;
FUNCTION "GET_CONST_3_LEADSOURCE_ID" RETURN VARCHAR;
...
-- Function Main -- Entry point in package "OWB_OPPORTUNITY_DIM"
--------------------------------------------------
