DROP PACKAGE BODY GKDW.OWB_ACCOUNT_DIM_NEW;

CREATE OR REPLACE PACKAGE BODY GKDW."OWB_ACCOUNT_DIM_NEW" AS
...
then null 
  ...
  "OWB_ACCOUNT_DIM_NEW"."GET_CONST_1_SOURCE" "SOURCE",
...
get_target_name := '"ACCOUNT_DIM"';
            ...
            "OWB_ACCOUNT_DIM_NEW"."GET_CONST_1_SOURCE";',0,2000);
            error_column := SUBSTRB('"ACCOUNT_DIM_18_GKDW_SOURCE"',0,80);
            
            BEGIN
              error_value := SUBSTRB("OWB_ACCOUNT_DIM_NEW"."GET_CONST_1_SOURCE",0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "OWB_ACCOUNT_DIM_NEW"."GET_CONST_1_SOURCE";
...
BEGIN
  -- Expression statement
      ...
      "GET_MAX_DATE"("OWB_ACCOUNT_DIM_NEW"."GET_CONST_0_TABLE_NAME","OWB_ACCOUNT_DIM_NEW"."PREMAPPING_1_CREATE_DATE_OUT","OWB_ACCOUNT_DIM_NEW"."PREMAPPING_2_MODIFY_DATE_OUT");
  ...
  ',0,2000);
    ...
    --"OWB_ACCOUNT_DIM_NEW"."PREMAPPING_1_CREATE_DATE_OUT" := '01-JAN-2011';
    --"OWB_ACCOUNT_DIM_NEW"."PREMAPPING_2_MODIFY_DATE_OUT" := '01-JAN-2011';
...
BEGIN
  ...
  AND    uo.object_name = 'OWB_ACCOUNT_DIM_NEW'
  AND    uo.object_id = ao.object_id;

  wb_rt_mapaudit_util.premap('OWB_ACCOUNT_DIM_NEW', x_schema, x_audit_id, x_object_id);
...
END "OWB_ACCOUNT_DIM_NEW";
/


GRANT EXECUTE, DEBUG ON GKDW.OWB_ACCOUNT_DIM_NEW TO DWHREAD;
