DROP PACKAGE GKDW.OWB_PRODUCT_DIM;

CREATE OR REPLACE PACKAGE GKDW."OWB_PRODUCT_DIM"  AS
...
get_lob_uoid                  CONSTANT VARCHAR2(40) := 'A41FFB19A85D5678E040007F01006C7D';
get_model_name                CONSTANT VARCHAR2(40) := '"OWB_PRODUCT_DIM"';
...
"CONST_0_CH_FLEX_VALUE_SET_ID" NUMBER := 1007697;
"CONST_1_MD_FLEX_VALUE_SET_ID" NUMBER := 1007698;
"CONST_2_TABLE_NAME" VARCHAR2(30) := 'PRODUCT_DIM';
"CONST_3_ORGANIZATION_ID" NUMBER := 88;
"CONST_4_INVOICEABLE_ITEM_FLAG" VARCHAR2(1) := 'Y';
"CONST_5_PL_FLEX_VALUE_SET_ID" NUMBER := 1007699;
"CONST_6_COUNTRY" VARCHAR2(30) := 'USA';
"CONST_7_GKDW_SOURCE" VARCHAR2(20) := 'SLXDW';
...
--            and package global storage for user-defined mapping input parameters
FUNCTION "GET_CONST_0_CH_FLEX_VALUE_SET_" RETURN NUMBER;
FUNCTION "GET_CONST_1_MD_FLEX_VALUE_SET_" RETURN NUMBER;
FUNCTION "GET_CONST_2_TABLE_NAME" RETURN VARCHAR2;
FUNCTION "GET_CONST_3_ORGANIZATION_ID" RETURN NUMBER;
FUNCTION "GET_CONST_4_INVOICEABLE_ITEM_" RETURN VARCHAR2;
FUNCTION "GET_CONST_5_PL_FLEX_VALUE_SET_" RETURN NUMBER;
FUNCTION "GET_CONST_6_COUNTRY" RETURN VARCHAR2;
FUNCTION "GET_CONST_7_GKDW_SOURCE" RETURN VARCHAR2;
...
-- Function Main -- Entry point in package "OWB_PRODUCT_DIM"
--------------------------------------------------
