DROP PACKAGE GKDW.OWB_EVENT_DIM;

CREATE OR REPLACE PACKAGE GKDW."OWB_EVENT_DIM"  AS
...
get_lob_uoid                  CONSTANT VARCHAR2(40) := 'A41FFB19A1A05678E040007F01006C7D';
get_model_name                CONSTANT VARCHAR2(40) := '"OWB_EVENT_DIM"';
...
"CONST_0_TABLE_NAME" VARCHAR2(30) := 'EVENT_DIM';
"CONST_1_SOURCE" VARCHAR2(20) := 'SLXDW';
"CONST_2_ENROLL_STATUS" VARCHAR2(50) := 'Did Not Attend';
...
FUNCTION "GET_CONST_2_ENROLL_STATUS" RETURN VARCHAR2;
...
-- Function Main -- Entry point in package "OWB_EVENT_DIM"
--------------------------------------------------
