DROP PACKAGE GKDW.OWB_MARKET_DIM;

CREATE OR REPLACE PACKAGE GKDW."OWB_MARKET_DIM"  AS
...
get_lob_uoid                  CONSTANT VARCHAR2(40) := 'A75448099E7849DAE040007F010067E5';
get_model_name                CONSTANT VARCHAR2(40) := '"OWB_MARKET_DIM"';
...
-- Function Main -- Entry point in package "OWB_MARKET_DIM"
--------------------------------------------------
