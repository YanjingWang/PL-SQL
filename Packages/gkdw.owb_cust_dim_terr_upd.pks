DROP PACKAGE GKDW.OWB_CUST_DIM_TERR_UPD;

CREATE OR REPLACE PACKAGE GKDW."OWB_CUST_DIM_TERR_UPD"  AS
...
get_lob_uoid                  CONSTANT VARCHAR2(40) := 'A7D1882008406CAFE040007F01002A48';
get_model_name                CONSTANT VARCHAR2(40) := '"OWB_CUST_DIM_TERR_UPD"';
...
-- Function Main -- Entry point in package "OWB_CUST_DIM_TERR_UPD"
--------------------------------------------------
