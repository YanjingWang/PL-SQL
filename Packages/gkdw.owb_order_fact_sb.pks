DROP PACKAGE GKDW.OWB_ORDER_FACT_SB;

CREATE OR REPLACE PACKAGE GKDW."OWB_ORDER_FACT_SB"  AS
...
get_lob_uoid                  CONSTANT VARCHAR2(40) := 'A41FFB19AB5B5678E040007F01006C7D';
get_model_name                CONSTANT VARCHAR2(40) := '"OWB_ORDER_FACT_SB"';
...
FUNCTION "GET_CONST_3_TERRITORY_TYPE" RETURN VARCHAR;
...
-- Function Main -- Entry point in package "OWB_ORDER_FACT_SB"
--------------------------------------------------
