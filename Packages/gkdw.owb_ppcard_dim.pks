DROP PACKAGE GKDW.OWB_PPCARD_DIM;

CREATE OR REPLACE PACKAGE GKDW."OWB_PPCARD_DIM"  AS
...
get_lob_uoid                  CONSTANT VARCHAR2(40) := 'A41FFB19CE255678E040007F01006C7D';
get_model_name                CONSTANT VARCHAR2(40) := '"OWB_PPCARD_DIM"';
...
"CONST_0_TABLE_NAME" VARCHAR2(30) := 'PPCARD_DIM';
...
-- Function Main -- Entry point in package "OWB_PPCARD_DIM"
--------------------------------------------------
