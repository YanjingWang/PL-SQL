DROP PACKAGE GKDW.OWB_GK_TERRITORY;

CREATE OR REPLACE PACKAGE GKDW."OWB_GK_TERRITORY"  AS
...
get_lob_uoid                  CONSTANT VARCHAR2(40) := 'A41FFB198F725678E040007F01006C7D';
get_model_name                CONSTANT VARCHAR2(40) := '"OWB_GK_TERRITORY"';
...
-- Function Main -- Entry point in package "OWB_GK_TERRITORY"
--------------------------------------------------
