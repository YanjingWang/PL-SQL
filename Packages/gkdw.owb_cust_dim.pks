DROP PACKAGE GKDW.OWB_CUST_DIM;

CREATE OR REPLACE PACKAGE GKDW."OWB_CUST_DIM"  AS
...
get_lob_uoid                  CONSTANT VARCHAR2(40) := 'A41FFB1991215678E040007F01006C7D';
get_model_name                CONSTANT VARCHAR2(40) := '"OWB_CUST_DIM"';
...
"CONST_0_TABLE_NAME" VARCHAR2(30) := 'CUST_DIM';
...
-- Function Main -- Entry point in package "OWB_CUST_DIM"
--------------------------------------------------
...
GRANT EXECUTE, DEBUG ON GKDW.OWB_CUST_DIM TO DWHREAD;
