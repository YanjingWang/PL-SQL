DROP PACKAGE BODY GKDW.OWB_ORDER_FACT_SB;

CREATE OR REPLACE PACKAGE BODY GKDW."OWB_ORDER_FACT_SB" AS
...
FROM
   ( SELECT
  "OWB_ORDER_FACT_SB"."PREMAPPING_1_CREATE_DATE_OUT" "CREATE_DATE_OUT",
  "OWB_ORDER_FACT_SB"."PREMAPPING_2_MODIFY_DATE_OUT" "MODIFY_DATE_OUT",
...
FROM
 ...
 LEFT OUTER JOIN   "SLXDW"."EVXBILLING"  "EVXBILLING" ON ( ( ( "EVXBILLING"."EVXBILLINGID" = "LOOKUP_INPUT_SUBQUERY"."EVXBILLINGID" ) ) )
  WHERE 
  "LOOKUP_INPUT_SUBQUERY".evxevenrollid in ('QGKID0B8YHZ1',
'Q6UJ90B7M55F',
'Q6UJ90B8AWLL',
'Q6UJ90B8CEEX',
'Q6UJ90B8CZ0H',
...
'QGKID0B90924',
'QGKID0B90911')
 and ( ( "LOOKUP_INPUT_SUBQUERY"."CREATEDATE_TXFEE" >= "LOOKUP_INPUT_SUBQUERY"."CREATE_DATE_OUT" or "LOOKUP_INPUT_SUBQUERY"."MODIFYDATE_TXFEE" >= "LOOKUP_INPUT_SUBQUERY"."MODIFY_DATE_OUT" ) 
...
get_target_name := '"ORDER_FACT"';
            ...
            "OWB_ORDER_FACT_SB"."GET_CONST_1_SOURCE";',0,2000);
            error_column := SUBSTRB('"ORDER_FACT_22_GKDW_SOURCE"',0,80);
            
            BEGIN
              error_value := SUBSTRB("OWB_ORDER_FACT_SB"."GET_CONST_1_SOURCE",0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "OWB_ORDER_FACT_SB"."GET_CONST_1_SOURCE";
...
BEGIN
  -- Expression statement
      ...
      GET_MAX_DATE("OWB_ORDER_FACT_SB"."GET_CONST_0_TABLE_NAME","OWB_ORDER_FACT_SB"."PREMAPPING_1_CREATE_DATE_OUT","OWB_ORDER_FACT_SB"."PREMAPPING_2_MODIFY_DATE_OUT");
  ...
  ',0,2000);
    ...
    -- End expression statement
--    "OWB_ORDER_FACT_SB"."PREMAPPING_1_CREATE_DATE_OUT" := '01-NOV-2015';
--    "OWB_ORDER_FACT_SB"."PREMAPPING_2_MODIFY_DATE_OUT" := '01-NOV-2015';
...
BEGIN
  ...
  AND    uo.object_name = 'OWB_ORDER_FACT_SB'
  AND    uo.object_id = ao.object_id;

  wb_rt_mapaudit_util.premap('OWB_ORDER_FACT_SB', x_schema, x_audit_id, x_object_id);
