DROP PACKAGE GKDW.OWB_SALES_ORDER_FACT_ORATX_UPD;

CREATE OR REPLACE PACKAGE GKDW."OWB_SALES_ORDER_FACT_ORATX_UPD"  AS
...
get_lob_uoid                  CONSTANT VARCHAR2(40) := 'A41FFB19C6805678E040007F01006C7D';
get_model_name                CONSTANT VARCHAR2(40) := '"OWB_SALES_ORDER_FACT_ORATX_UPD"';
...
"CONST_0_TRANSACTIONTYPE" VARCHAR2(32) := 'Recapture';

-- Access functions for user-defined variables via mapping Variable components,
--            and package global storage for user-defined mapping input parameters
FUNCTION "GET_CONST_0_TRANSACTIONTYPE" RETURN VARCHAR2;
...
-- Function Main -- Entry point in package "OWB_SALES_ORDER_FACT_ORATX_UPD"
--------------------------------------------------
