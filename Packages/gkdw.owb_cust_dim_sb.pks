DROP PACKAGE GKDW.OWB_CUST_DIM_SB;

CREATE OR REPLACE PACKAGE GKDW."OWB_CUST_DIM_SB"  AS
...
get_model_name                CONSTANT VARCHAR2(40) := '"OWB_CUST_DIM_SB"';
...
-- Function Main -- Entry point in package "OWB_CUST_DIM_SB"
--------------------------------------------------
