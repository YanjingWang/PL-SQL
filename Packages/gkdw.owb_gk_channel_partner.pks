DROP PACKAGE GKDW.OWB_GK_CHANNEL_PARTNER;

CREATE OR REPLACE PACKAGE GKDW."OWB_GK_CHANNEL_PARTNER"  AS
...
get_lob_uoid                  CONSTANT VARCHAR2(40) := 'A41FFB19CC485678E040007F01006C7D';
get_model_name                CONSTANT VARCHAR2(40) := '"OWB_GK_CHANNEL_PARTNER"';
...
"GK_CHANNEL_PARTNER_GKDW_St" Boolean;
...
-- Function Main -- Entry point in package "OWB_GK_CHANNEL_PARTNER"
--------------------------------------------------
