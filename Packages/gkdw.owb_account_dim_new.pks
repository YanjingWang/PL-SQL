DROP PACKAGE GKDW.OWB_ACCOUNT_DIM_NEW;

CREATE OR REPLACE PACKAGE GKDW."OWB_ACCOUNT_DIM_NEW"  AS
...
get_lob_uoid                  CONSTANT VARCHAR2(40) := 'A41FFB198C605678E040007F01006C7D';
get_model_name                CONSTANT VARCHAR2(40) := '"OWB_ACCOUNT_DIM_NEW"';
...
"CONST_0_TABLE_NAME" VARCHAR2(30) := 'ACCOUNT_DIM';
...
-- Function Main -- Entry point in package "OWB_ACCOUNT_DIM_NEW"
--------------------------------------------------
