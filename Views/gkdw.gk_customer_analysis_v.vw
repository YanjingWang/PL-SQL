DROP VIEW GKDW.GK_CUSTOMER_ANALYSIS_V;

/* Formatted on 29/01/2021 11:38:45 (QP5 v5.115.810.9015) */
CREATE OR REPLACE FORCE VIEW GKDW.GK_CUSTOMER_ANALYSIS_V
(
   DIM_YEAR,
   DIM_QTR,
   DIM_MONTH,
...
AS
     SELECT   td.dim_year,
              ...
              NVL (qa.group_naics_desc, n.naics_desc) naics_desc,
   ...
   GROUP BY   td.dim_year,
              ...
              NVL (qa.group_naics_desc, n.naics_desc),
              ad.acct_name,
              ad.acct_id,
              ad.city,
              ad.state,
