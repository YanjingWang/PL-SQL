DROP VIEW GKDW.GK_PRODUCT_INST_COST_V;

/* Formatted on 29/01/2021 11:29:19 (QP5 v5.115.810.9015) */
CREATE OR REPLACE FORCE VIEW GKDW.GK_PRODUCT_INST_COST_V
(
   COST_TYPE,
   EVENT_ID,
   EVENT_DESC,
...
AS
     SELECT   'Instructor Cost' cost_type,
              ...
              cd.vendor_code,
              SUM (NVL (pl.item_qty, 0) * NVL (pl.item_unit_price, 0)) inst_amt
