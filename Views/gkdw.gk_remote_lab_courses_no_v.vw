DROP VIEW GKDW.GK_REMOTE_LAB_COURSES_NO_V;

/* Formatted on 29/01/2021 11:28:09 (QP5 v5.115.810.9015) */
CREATE OR REPLACE FORCE VIEW GKDW.GK_REMOTE_LAB_COURSES_NO_V
(
   COURSE_ID,
   RMS_PRODUCT_ID,
   RMS_MODE_ID,
