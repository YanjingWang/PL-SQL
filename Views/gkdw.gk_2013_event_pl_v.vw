DROP VIEW GKDW.GK_2013_EVENT_PL_V;

/* Formatted on 29/01/2021 11:21:58 (QP5 v5.115.810.9015) */
CREATE OR REPLACE FORCE VIEW GKDW.GK_2013_EVENT_PL_V
(
   COURSE_PL,
   DIM_QUARTER,
   FILL_RATE_0,
...
AS
   ...
   GROUP BY   c.course_pl, e.dim_quarter
   ORDER BY   c.course_pl, e.dim_quarter;
