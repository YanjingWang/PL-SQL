DROP VIEW GKDW.GK_2013_EVENT_TECH_V;

/* Formatted on 29/01/2021 11:21:36 (QP5 v5.115.810.9015) */
CREATE OR REPLACE FORCE VIEW GKDW.GK_2013_EVENT_TECH_V
(
   COURSE_PL,
   COURSE_TYPE,
   DIM_QUARTER,
...
AS
   ...
   GROUP BY   c.course_pl, c.course_type, e.dim_quarter
   ORDER BY   c.course_pl, c.course_type, e.dim_quarter;
