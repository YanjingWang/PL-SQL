DROP VIEW GKDW.GK_2013_EVENT_COURSE_METRO_V;

/* Formatted on 29/01/2021 11:21:50 (QP5 v5.115.810.9015) */
CREATE OR REPLACE FORCE VIEW GKDW.GK_2013_EVENT_COURSE_METRO_V
(
   COURSE_CODE,
   METRO,
   FILL_RATE_0,
...
AS
   ...
   GROUP BY   c.course_code, e.metro
   ORDER BY   c.course_code, e.metro;
