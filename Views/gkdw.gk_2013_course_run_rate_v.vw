DROP VIEW GKDW.GK_2013_COURSE_RUN_RATE_V;

/* Formatted on 29/01/2021 11:22:06 (QP5 v5.115.810.9015) */
CREATE OR REPLACE FORCE VIEW GKDW.GK_2013_COURSE_RUN_RATE_V
(
   OPS_COUNTRY,
   COURSE_CODE,
   EVENT_CNT,
