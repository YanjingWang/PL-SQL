DROP VIEW GKDW.GK_ONSITE_SOLD_V;

/* Formatted on 29/01/2021 11:31:24 (QP5 v5.115.810.9015) */
CREATE OR REPLACE FORCE VIEW GKDW.GK_ONSITE_SOLD_V
(
   ENROLLID,
   ENROLL_AMT,
   NET_AMT,
...
AS
   SELECT   eh.evxevenrollid enrollid,
            ...
            ev.enddate event_end_date,
            ui.username sold_by,
            ui.department sold_by_dept,
