DROP VIEW GKDW.GK_TPS_DATA_V;

/* Formatted on 29/01/2021 11:24:45 (QP5 v5.115.810.9015) */
CREATE OR REPLACE FORCE VIEW GKDW.GK_TPS_DATA_V
(
   TAB_TYPE,
   SALES_REP,
   SALES_REP_EMAIL,
...
AS
   ...
   ORDER BY   sales_rep, tab_type, dim_month_num;
