DROP VIEW GKDW.GK_SCHED_FUTURE_V;

/* Formatted on 29/01/2021 11:26:41 (QP5 v5.115.810.9015) */
CREATE OR REPLACE FORCE VIEW GKDW.GK_SCHED_FUTURE_V
(
   DIM_YEAR,
   COUNTRY,
   COURSE_CH,
...
AS
     SELECT   TO_CHAR (SYSDATE, 'YYYY') - 0 dim_year,
              country,
              course_ch,
              course_mod,
              course_pl,
       ...
       FROM   (  SELECT   cd.country,
               ...
               GROUP BY   cd.country,
                          ...
                          cd.short_name,
                          cd.duration_days)
   GROUP BY   TO_CHAR (SYSDATE, 'YYYY') - 0,
              country,
              course_ch,
              course_mod,
              course_pl,
