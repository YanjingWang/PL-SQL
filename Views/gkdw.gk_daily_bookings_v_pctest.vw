DROP VIEW GKDW.GK_DAILY_BOOKINGS_V_PCTEST;

/* Formatted on 29/01/2021 11:38:12 (QP5 v5.115.810.9015) */
CREATE OR REPLACE FORCE VIEW GKDW.GK_DAILY_BOOKINGS_V_PCTEST
(
   ENROLLID,
   ENROLL_AMT,
   STATUS_DESC,
