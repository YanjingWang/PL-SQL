DROP VIEW GKDW.GK_EVENT_MEETING_DAYS_V_BAK;

/* Formatted on 29/01/2021 11:36:53 (QP5 v5.115.810.9015) */
CREATE OR REPLACE FORCE VIEW GKDW.GK_EVENT_MEETING_DAYS_V_BAK
(
   EVENT_ID,
   ADJ_DAY_VAL
)
