DROP VIEW GKDW.GK_OPS_SESSION_V;

/* Formatted on 29/01/2021 11:31:11 (QP5 v5.115.810.9015) */
CREATE OR REPLACE FORCE VIEW GKDW.GK_OPS_SESSION_V
(
   EVENTCOUNTRY,
   DIM_YEAR,
   DIM_WEEK,
...
AS
   SELECT   DISTINCT
    ...
    WHERE       ed.start_date = td.dim_date
            ...
            AND ed.event_id = re.slx_event_id
...
DROP PUBLIC SYNONYM GK_OPS_SESSION_V;

CREATE PUBLIC SYNONYM GK_OPS_SESSION_V FOR GKDW.GK_OPS_SESSION_V;
