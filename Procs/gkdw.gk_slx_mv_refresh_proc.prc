DROP PROCEDURE GKDW.GK_SLX_MV_REFRESH_PROC;

CREATE OR REPLACE PROCEDURE GKDW.gk_slx_mv_refresh_proc
AS
   --=======================================================================
...
BEGIN
 ...
 --  rms_link_set_proc;
   ...
   v_count := 10;
   DBMS_SNAPSHOT.REFRESH ('gkdw.gk_portal_ticket_mv');
   DBMS_OUTPUT.put_line ('gk_portal_ticket_mv complete: ' || TO_CHAR (SYSDATE, 'hh24:mi:ss'));
   v_count := 20;
   DBMS_SNAPSHOT.REFRESH ('gkdw.gk_portal_enroll_mv');
   DBMS_OUTPUT.put_line ('gk_portal_enroll_mv complete: ' || TO_CHAR (SYSDATE, 'hh24:mi:ss'));
