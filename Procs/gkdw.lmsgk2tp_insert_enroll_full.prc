DROP PROCEDURE GKDW.LMSGK2TP_INSERT_ENROLL_FULL;

CREATE OR REPLACE PROCEDURE GKDW.LMSGK2TP_insert_enroll_full  as 
...
cursor c1 is 
    ...
    left join slxdw.GK_ENROLLMENT ge on ge.EVXEVENROLLID = f.ENROLL_ID
    where  substr(ed.COURSE_CODE, -1, 1) in ( 'A','C', 'G', 'W', 'Z') 
    ...
    where substr(ed.COURSE_CODE, -1, 1) in ( 'N', 'H', 'I', 'J') 
        and ed.COUNTRY in ('USA', 'CANADA')
         and ed.START_DATE >= '01-JUL-2017'    ;
