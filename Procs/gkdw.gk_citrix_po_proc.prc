DROP PROCEDURE GKDW.GK_CITRIX_PO_PROC;

CREATE OR REPLACE PROCEDURE GKDW.gk_citrix_po_proc(p_test varchar2 default 'N') as
...
if c1%found then
  ...
  if p_test = 'Y' then
    ...
    send_mail('globalcitrix@globalknowledge.com','bala.subramanian@globalknowledge.com','Global Knowledge Citrix CTP Purchase Request',v_msg_body);
  end if;
