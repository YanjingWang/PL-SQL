DROP PROCEDURE GKDW.LMSGK2TP_INSERT_FACILITIES;

CREATE OR REPLACE PROCEDURE GKDW.LMSGK2TP_insert_facilities  as 
...
--and mc."name" <> 'ONS'
   and ef.FACILITYSTATUS = 'Active'
--and (ef.CREATEDATE >= '01-NOV-2010' or ef.MODIFYDATE >= '01-NOV-2010') 
   and (ef.CREATEDATE >= LAST_RUN_DATE_OUT or ef.MODIFYDATE >= LAST_RUN_DATE_OUT)
