DROP PROCEDURE GKDW.GK_CD_FEE_PROC_TEST;

CREATE OR REPLACE PROCEDURE GKDW.gk_cd_fee_proc_test(p_name varchar2) as
...
send_mail_attach('DW.Automation@globalknowledge.com','Purchasing.Requests.US@globalknowledge.com','',null,v_mail_hdr,'CD Fee PO Report',v_file_name_full_po);
send_mail_attach('DW.Automation@globalknowledge.com','jennifer.parker@globalknowledge.com','john.nealis@globalknowledge.com','Michalina.DeBoard@globalknowledge.com',v_mail_hdr,'CD Fee PO Report',v_file_name_full_po);
...
send_mail_attach('DW.Automation@globalknowledge.com','Brad.Puckett@globalknowledge.com','',null,v_mail_hdr,'CD Fee PO Report',v_file_name_full_po);
