DROP PROCEDURE GKDW.GK_TERILLIAN_EVENTS_LOAD_NEW;

CREATE OR REPLACE PROCEDURE GKDW.gk_terillian_events_load_new as
   --=======================================================================
...
v_file := utl_file.fopen('/mnt/shared_ww/lods',v_sessions_file,'w');
