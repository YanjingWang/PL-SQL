DROP PROCEDURE GKDW.GK_PARTNER_PORTAL_LOAD_PROC;

CREATE OR REPLACE PROCEDURE GKDW.gk_partner_portal_load_proc(p_partner varchar2) as

/* Modified By             :  Smaranika Baral
   Modification Date       :  2/19/2020
   Content of Modification :  replaced gk_emea_mv_rebuild_proc by 
                              dbms_snapshot.refresh('gkdw.GK_IBM_EMEA_PORTAL_LOAD_MV');
...
dbms_snapshot.refresh('gkdw.GK_IBM_EMEA_PORTAL_LOAD_MV');--changed by sbaral
