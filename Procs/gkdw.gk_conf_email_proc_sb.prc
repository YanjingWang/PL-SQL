DROP PROCEDURE GKDW.GK_CONF_EMAIL_PROC_SB;

CREATE OR REPLACE PROCEDURE GKDW.gk_conf_email_proc_sb as
...
/******* Additional Information **********/
  ...
  send_mail_sb('ConfirmAdmin.NAm@globalknowledge.com','smaranika.baral@globalknowledge.com','CC-Important Course Access Details from Global Knowledge ('||r1.evxevenrollid||')','gk_conf_email_proc_sb Test');
  send_mail_sb('ConfirmAdmin.NAm@globalknowledge.com','bala.subramanian@globalknowledge.com','Important Course Access Details from Global Knowledge ('||r1.evxevenrollid||')','gk_conf_email_proc_sb Test');
...
/******* OUTLOOK ENROLLMENT ********/
  if r1.cal_reminder = 'Y' and r1.channel_flag = 'N' then
   ...
   -- v_msg_body := v_msg_body||r1.event_survey; -- SR 05/08/2017
    ...
    send_ical_email_sb('ConfirmAdmin.NAm@globalknowledge.com','smaranika.baral@globalknowledge.com','Global Knowledge Training Event ('||r1.evxevenrollid||')','gk_conf_email_proc_sb Test',v_ical_event);
    send_ical_email_sb('ConfirmAdmin.NAm@globalknowledge.com','bala.subramanian@globalknowledge.com','Global Knowledge Training Event ('||r1.evxevenrollid||')','gk_conf_email_proc_sb Test',v_ical_event);
  end if;
...
exception 
  when others then
    ...
    send_mail_sb('DW.Automation@globalknowledge.com','smaranika.baral@globalknowledge.com','GK_CONF_EMAIL_PROC error in evxevenrollid: '||r1.evxevenrollid,SQLERRM); 
    send_mail_sb('DW.Automation@globalknowledge.com','bala.subramanian@globalknowledge.com','GK_CONF_EMAIL_PROC error in evxevenrollid: '||r1.evxevenrollid,SQLERRM); 
end;
...
exception
  when others then
    rollback;
    send_mail_sb('DW.Automation@globalknowledge.com','smaranika.baral@globalknowledge.com','GK_CONF_EMAIL_PROC Failed',SQLERRM);
    send_mail_sb('DW.Automation@globalknowledge.com','bala.subramanian@globalknowledge.com','GK_CONF_EMAIL_PROC Failed',SQLERRM);
end;
/
