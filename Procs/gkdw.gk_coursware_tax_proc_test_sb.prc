DROP PROCEDURE GKDW.GK_COURSWARE_TAX_PROC_TEST_SB;

CREATE OR REPLACE PROCEDURE GKDW.gk_coursware_tax_proc_test_sb(v_tax_type varchar2) as
...
exception
  when others then
    ...
    send_mail('DW.Automation@globalknowledge.com','smaranika.baral@globalknowledge.com','GK_COURSEWARE_TAX_PROC Failed',SQLERRM);
