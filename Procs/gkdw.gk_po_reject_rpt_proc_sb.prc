DROP PROCEDURE GKDW.GK_PO_REJECT_RPT_PROC_SB;

CREATE OR REPLACE PROCEDURE GKDW.gk_po_Reject_rpt_proc_sb as
   --=======================================================================
...
begin
  ...
  send_mail_attach_sb('DW.Automation@globalknowledge.com','smaranika.baral@globalknowledge.com','','','SEND_MAIL_ATTACH test','Open Excel Attachment.',v_file_name_full);   
  send_mail_attach_sb('DW.Automation@globalknowledge.com','bala.subramanian@globalknowledge.com','','','SEND_MAIL_ATTACH test','Open Excel Attachment.',v_file_name_full); 
   

exception
  when others then
    send_mail_sb('DW.Automation@globalknowledge.com','smaranika.baral@globalknowledge.com','GK_PO_REJECT_RPT_PROC failed',SQLERRM);
