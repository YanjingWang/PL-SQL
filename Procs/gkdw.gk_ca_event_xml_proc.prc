DROP PROCEDURE GKDW.GK_CA_EVENT_XML_PROC;

CREATE OR REPLACE PROCEDURE GKDW.gk_ca_event_xml_proc as
cursor c0 is
...
select 'caevents22.xml',
       '/mnt/nc10s141_ibm/ww/rss-ibm/caevents22.xml'
...
sys.system_run('mv /mnt/nc10s141_ibm/ww/rss-ibm/caevents22.xml /mnt/emea_b2b/B2B_EMEA_LIVE/CA/caevents22.xml');

exception
  when others then
    rollback;
  send_mail('DW.Automation@globalknowledge.com','DW.Automation@globalknowledge.com','GK CA EVENT FEED XML Failed',SQLERRM);
