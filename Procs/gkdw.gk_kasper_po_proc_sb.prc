DROP PROCEDURE GKDW.GK_KASPER_PO_PROC_SB;

CREATE OR REPLACE PROCEDURE GKDW.gk_kasper_po_proc_sb(p_test varchar2 default 'N') as
...
if c1%found then
  ...
  if p_test = 'Y' then
    ...
    send_mail('DW.Automation@globalknowledge.com','sruthi.reddy@globalknowledge.com','Global Knowledge - KL ATC License Payment',v_msg_body);
  end if;
