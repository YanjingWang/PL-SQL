DROP PROCEDURE GKDW.SEND_MAIL_SB;

CREATE OR REPLACE PROCEDURE GKDW.send_mail_sb (sender varchar2,
                                       recip varchar2,
                                       subject varchar2,
                                       message long) as

--mailhost varchar2(50) := 'corpmail.globalknowledge.com';
mailhost varchar2(50) ;--:= 'smtp.globalknowledge.com';--changed by SBaral
