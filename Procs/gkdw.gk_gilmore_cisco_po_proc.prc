DROP PROCEDURE GKDW.GK_GILMORE_CISCO_PO_PROC;

CREATE OR REPLACE PROCEDURE GKDW.gk_gilmore_cisco_po_proc(p_test varchar2 default 'N') as
...
if p_test = 'Y' then
      ...
      v_error:= SendMailJPkg.SendMail(
            SMTPServerName => 'corpmail.globalknowledge.com',
            Sender    => 'dw.automation@globalknowledge.com',
            Recipient => 'accounts.PayableCary@globalknowledge.com',
