DROP PROCEDURE GKDW.SEND_ICAL_EMAIL_SB;

CREATE OR REPLACE PROCEDURE GKDW.send_ical_email_SB
( 
    p_from      IN VARCHAR2 
  , p_to        IN VARCHAR2 
...
as
   ...
   l_mail_serv  VARCHAR2(50) ;--:= 'smtp.globalknowledge.com'; 
