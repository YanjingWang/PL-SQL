DROP PROCEDURE GKDW.GK_ITP_EXAMS_PROC_TEST;

CREATE OR REPLACE PROCEDURE GKDW.gk_itp_exams_proc_test is
...
-- ITP RETAKE EVENT DATA SET -- not needed for People Cert 09/10/2018
--cursor c3 is
--select 269 requestor_id,
--       43258 vendor_id,'SMITHTOWN' vendor_site_code,84 v_org_id,101 v_inv_org_id,
--        case when cd.course_code in ('2754W','2761W') then '000' else '130' end fe_num,
...
--WEEKLY ITP RETAKE VOUCHER PROCESS -- Not needed for People Cert 09/10/2018
