DROP PROCEDURE GKDW.GK_CA_LOCATION_XML_PROC;

CREATE OR REPLACE PROCEDURE GKDW.gk_ca_location_xml_proc as
...
select 'calocations22.xml',
       '/mnt/nc10s141_ibm/ww/rss-ibm/calocations22.xml'
...
sys.system_run('mv /mnt/nc10s141_ibm/ww/rss-ibm/calocations22.xml /mnt/emea_b2b/B2B_EMEA_LIVE/CA/calocations22.xml');


exception
  when others then
    rollback;
  send_mail('DW.Automation@globalknowledge.com','DW.Automation@globalknowledge.com','GK CA LOCATION FEED XML Failed',SQLERRM);
